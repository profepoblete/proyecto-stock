                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Modificar Usuario</h3></div>
                                    <div class="justify-content-center" style="text-align: center;" id="divAlert"></div>
                                    <div class="card-body">
                                        <form action="UpdUsuario" method="post" id="frmEditar" name="frmEditar" accept-charset="ISO-8859-1" autocomplete="off">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName"><i data-feather="user-x"></i> Código</label>
                                                        <div class="form-group" id="fg_rut">
                                                            <input class="form-control py-4" id="txtId_usuario"  name="txtId_usuario"  type="text" placeholder="11.111.111.1" readonly="" value="<%= objUser.getId_usuario()%>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"id="fg_rut">
                                                            <input class="form-control py-4" id="txtRut_Usuario" oninput="checkRut(this)" name="txtRut_Usuario" type="text" placeholder="Rut" value="<%= objUser.getRut_usuario()%>" /><%--readonly=""--%>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">	
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="ddlCentro_Costo" name="ddlCentro_Costo" value="">
                                                            <%
                                                            try {
                                                                   objCon.getConn();
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"id="fg_password">
                                                            <input class="form-control py-4" id="txtPassword_usuario" name="txtPassword_usuario" type="password" placeholder="Ingrese Contraseña" value="<%= objUser.getPassword_usuario()%>"/></div>
                                                        </div> 
                                                        
                                                </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0">
                                                <input class="btn btn-primary btn-block" name="btnGuardar" type="submit" value="Editar Usuario">
                                            </div>
                                        </form>
                                    </div>
                                </div>
