                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group"id="fg_codigo">
                                                        <input class="form-control py-4" type="text" id="txtCodigo_bodega" name="txtCodigo_bodega" maxlength="10" placeholder="Ingrese Código" aria-label="Organization Name" aria-describedby="orgNameExample" readonly="" value="<%= objBodega.getCodigo_bodega() %>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group"id="fg_volumen">
                                                        <input class="form-control py-4" type="number" id="txtVolumen_bodega" name="txtVolumen_bodega" maxlength="11" min="0" placeholder="Ingrese Volumen en Números" aria-label="Organization Name" aria-describedby="orgNameExample" value="<%= objBodega.getVolumen_bodega() %>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group"id="fg_ubicacion">
                                                        <input class="form-control py-4" type="text" id="txtUbicacion_bodega" name="txtUbicacion_bodega" maxlength="45" placeholder="Ingrese Ubicación" aria-label="Organization Name" aria-describedby="orgNameExample" value="<%= objBodega.getUbicacion_bodega() %>" />
                                                    </div>
                                                </div>
                                            </div>        
