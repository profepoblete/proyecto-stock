                    ...
                    <div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
                        <div class="container-fluid">
                            <div class="page-header-content">
                                ...
                                <div class="page-header-subtitle">Lista filtrada de proveedores</div>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid mt-n10">
                                ...
                                <form class="form-inline" action="BuscarProveedor" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar
                                            ...
                                            <button class="btn btn-primary btn-sm" style="margin-left: 5px;" type="submit" name="btnBuscar" id="btnBuscar">Buscar</button>
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaProveedor.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                        </label>
                                    </div>
                                </form>
						...
						<th>Acciones</th>
                                    ...
                                    <%
                                        ...
                                        lista = (List<Proveedor>) sessionMostrar.getAttribute("lstBuscarProveedor");
