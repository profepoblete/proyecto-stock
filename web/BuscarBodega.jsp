                            ...
                            <div class="card-body">
                                <form class="form-inline" action="BuscarBodega" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar&nbsp;
                                            ...
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaBodegas.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                        </label>
                                    </div>
                                </form>
                                <div class="datatable table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        lista = (List<Bodega>)sessionMostrar.getAttribute("lstBuscarBodega");
                                        Iterator<Bodega> iter = lista.iterator();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%= objBodega.getVolumen_bodega() %></td>
                                                <td><%= objBodega.getUbicacion_bodega() %></td>
                                                <td><%= objBodega.getCodigo_centro_costo() %></td>
