                    ...
                    <div class="container-fluid mt-n10">
                                ...
                                <form class="form-inline" action="BuscarTipoProducto" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar&nbsp;
                                            ...
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaTipoProducto.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                        </label>
                                    </div>
                                </form>
						...
						<th colspan="2">Acciones</th>
                                   ...
                                   <%
                                            ...
                                            lista = (List<TipoProducto>) sessionMostrar.getAttribute("lstBuscarTipoProducto");
                                            Iterator<TipoProducto> iter = lista.iterator();
