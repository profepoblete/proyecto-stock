...
<%
            ...
            Ubicacion objUbicacion = (Ubicacion)sessionMostrar.getAttribute("objUbicacion");
            String codigo_ubicacion = (String)sessionMostrar.getAttribute("codigo_ubicacion");
            objUbicacion.setCodigo_ubicacion(codigo_ubicacion);
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    ...
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Editar Ubicacion</h3></div>
                                    <div class="justify-content-center" style="text-align: center;" id="divAlert"></div>
                                    <div class="card-body">
                                            <form action="UpdUbicacion" method="post" id="frmEditarubicacion" name="frmEditarubicacion" method="post" autocomplete="off" accept-charset="ISO-8859-1">
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group" id="fg_codigo_ubicacion">
                                                                <input class="form-control py-4" id="txtCodigo_ubicacion" name="txtCodigo_ubicacion"  name="txtCodigo_ubicacion"  type="text" readonly="" value="<%= objUbicacion.getCodigo_ubicacion()%>" placeholder="000000" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group" id="fg_descripcion_ubicacion">
                                                                <input class="form-control py-4" id="txtDescripcion_ubicacion"  name="txtDescripcion_ubicacion"  type="text" value="<%= objUbicacion.getDescripcion_ubicacion()%>" placeholder="lugar,piso etc..." />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group mt-4 mb-0">
                                                   <input class="btn btn-primary btn-block" name="btnGuardar" type="submit" value="Editar Ubicacion">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
