                            ...
                            <div class="card-body">
                                <form class="form-inline" action="BuscarCentroCosto" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar&nbsp;
                                            ...
                                            <!--ESTO FUE CAMBIADO V-->
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaCentroDeCosto.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                            <!--ESTO FUE CAMBIADO ^-->
                                        </label>
                                    </div>
                                </form>
                                <div class="datatable table-responsive">
                                    ...
                                    <%
                                        ...
                                        lista = (List<CentroCosto>) sessionMostrar.getAttribute("lstBuscarCentroCosto");
                                        Iterator<CentroCosto> iter = lista.iterator();
