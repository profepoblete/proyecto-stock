<%-- 
    Document   : Ingreso Producto Especifico
...
<html lang="en">
    <head>
        ...
        <title>Tabla Ingreso producto Especifico</title>
            ...
            <div id="layoutSidenav">
                ...
                <div id="layoutSidenav_content">
                    <main>
                        ...
                        <div class="container-fluid mt-n10 text-center">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">                                
                                    <div  class="datatable table-responsive" style="overflow-x: auto;">
                                        ...
                                        <%                                            ProductoDAO objDAOProducto = new ProductoDAO();
                                            ...
                                            ArrayList<ProductoEsp> lstProductoEsp = objProductoEspDAO.ListarProductoEsp();

                                            //2 iterator y null
                                            Iterator<Producto> iter = lstProducto.iterator();
                                            Producto objProducto = null;
                                            Iterator<ProductoEsp> iterEsp = lstProductoEsp.iterator();
                                        ...
                                        <tbody style="white-space: normal;">
                                            <tr >
                                                ...
                                                <td>
                                                    <a href="AddProductoEsp.jsp?id_producto=<%= objProducto.getId_producto()%>" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Ingresar</a>
                                                </td>
                                            </tr>
                                            <% } %>
                                            <% } %>
