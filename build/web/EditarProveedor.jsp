                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group" id="fg_rut">
                                                                <input class="form-control py-4" id="txtRut_Proveedor"  name="txtRut_Proveedor"  type="text" placeholder="11.111.111.1" value="<%= objProveedor.getRut_proveedor()%>"/><%--antes con readonly=""--%>
                                                            </div>
                                                        </div>
                                                    </div>
