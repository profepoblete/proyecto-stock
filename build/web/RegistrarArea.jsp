                                ...
                                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                                    <div class="card mt-5">
                                        <div class="card-body p-5 text-center">
                                            ...
                                            <div class="h3 text-primary font-weight-300 mb-0">Ingresar Área</div>
                                        </div>
                                        ...
                                        <div class="card-body p-5">
                                            <form action="AddArea" id="frmAgregarArea" name="frmAgregarArea" method="post" autocomplete="off" accept-charset="ISO-8859-1">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"id="fg_codigo">
                                                            <input class="form-control py-4" id="txtCodigo_area"  name="txtCodigo_area" maxlength="10" type="text"  placeholder="Ingrese Código" aria-label="Organization Name" aria-describedby="orgNameExample" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"id="fg_nombre">
                                                            <input class="form-control py-4" id="txtNombre_area"  name="txtNombre_area" maxlength="45" type="text"  placeholder="Ingrese Nombre" aria-label="Organization Name" aria-describedby="orgNameExample" />
                                                        </div>
                                                    ...
                                                    <input class="btn btn-primary btn-block" name="btnGuardar" type="submit" value="Registrar Area">
                                                </div>
                                        </form>
                                    </div>
                                </div>
