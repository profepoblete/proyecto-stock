...
$( function() {
        ...
        $("#txtBuscar").bind("keydown", function(event){
            var data = {nombre_producto:$("#txtBuscar").val()};
    ...
    //Funcion texto predictivo Id ubicaion
$( function() {
...
$( function() {
        ...
        $("#txtBuscarInv").bind("keydown", function(event){
            var data = {descripcion_inventario:$("#txtBuscarInv").val()};
            $.getJSON("buscarInv", data, function(res,est,jqXHR){
                availableTags.length = 0;
                $.each(res, function(i, item){
                    availableTags[i] = item;
                    });
