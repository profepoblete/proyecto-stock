                    ...
                    <div class="container-fluid mt-n10">
                                ...
                                <form class="form-inline" action="BuscarTipoUnidad" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar&nbsp;
                                            ...
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaTipoUnidad.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                        </label>
                                    </div>
                                </form>
						...
						<th colspan="2">Acciones</th>
                                        ...
                                        <%
                                            ...
                                            List<TipoUnidad> lista = new ArrayList<TipoUnidad>();
                                            lista = (List<TipoUnidad>) sessionMostrar.getAttribute("lstBuscarTipoUnidad");
                                            Iterator<TipoUnidad> iter = lista.iterator();
