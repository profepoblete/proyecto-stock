                            ...
                            <div class="card-body">
                                ...
                                <div class="datatable table-responsive" style="overflow-x: auto;">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <%
                                            TipoMenuDAO objDAOTipoMenu = new TipoMenuDAO();
                                            TipoMenu objTipoMenu = null;
                                            MenuDAO objDAOMenu = new MenuDAO();
                                            Menu objMenu2 = new Menu();
                                            TipoMenu objTipoMenuXUsuario = new TipoMenu();
                                            objTipoMenuXUsuario.setId_tipo_usuario(objTipoUsuario.getId_tipo_usuario());
                                            ArrayList<TipoMenu> lstTipoMenuXUsuario = objDAOTipoMenu.buscarTipoMenuPorId(objTipoMenuXUsuario);
                                            Iterator<TipoMenu> iterTipoMenu = lstTipoMenuXUsuario.iterator();
                                           while(iterTipoMenu.hasNext()){
                                               objTipoMenu = iterTipoMenu.next();
                                               int id = objTipoMenu.getId_menu();
                                               objMenu2.setId_menu(id);
                                               objMenu2 = objDAOMenu.buscarMenuPorId(objMenu2);
