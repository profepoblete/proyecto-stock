                            ...
                            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                                <div class="card mt-5">
                                    ...
                                    <div class="card-body p-5">
                                        <form action="AddTipoProducto" id="frmAgregarTipoProducto" method="post" autocomplete="off" accept-charset="ISO-8859-1">
                                            <label class="small mb-1" for="inputFirstName"><i data-feather="user-x"></i> Categoria Tipo Producto</label>
                                                        <div class="form-group"id="fg_categoria_tipo_producto">
                                                            <input class="form-control py-4" id="txtCategoria_tipo_producto" name="txtCategoria_tipo_producto" type="text" placeholder="Electronica,Aseo..." />
                                                        </div>
