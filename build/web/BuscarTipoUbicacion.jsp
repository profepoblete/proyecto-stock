                            ...
                            <div class="card-body">
                                <form class="form-inline" action="BuscarTipoUbicacion" method="post" autocomplete="off">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label>Buscar&nbsp;
                                            ...
                                            <a class="btn btn-primary btn-sm" style="margin-left: 5px;" type="button" href="ListaTipoUbicacion.jsp" name="btnBuscar" id="btnBuscar">Volver</a>
                                        </label>
                                    </div>
                                </form>
                                <div class="datatable table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        List<TipoUbicacion> lista = new ArrayList<TipoUbicacion>();
                                        lista = (List<TipoUbicacion>)sessionMostrar.getAttribute("lstBuscarTipoUbicacion");
                                        Iterator<TipoUbicacion> iter = lista.iterator();
